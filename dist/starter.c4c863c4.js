...
const $a916605b4ec9bc12$export$a75c676177490cac = async function(url) {
    try {
...
const $e58a49189aca5ad3$export$ca000e230c0caa3e = {
    recipe: {},
    search: {
        results: [],
        page: 1,
...
const $e58a49189aca5ad3$export$b96725c7a035d60b = async function(id) {
    try {
        const data = await (0, $a916605b4ec9bc12$export$a75c676177490cac)(`${(0, $949cefe0e606d775$export$923ea8233b386e99)}${id}`);
        const { recipe: recipe } = data.data;
        $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe = {
            id: recipe.id,
            title: recipe.title,
        ...
        console.log($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe);
        if ($e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr.some(function(bookmark) {
            return bookmark.id === id;
        })) $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.bookmarked = true;
        else $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.bookmarked = false;
    } catch (err) {
        throw err;
    }
};
const $e58a49189aca5ad3$export$1a43a08845d6b60 = async function(query) {
    try {
        const data = await (0, $a916605b4ec9bc12$export$a75c676177490cac)(`${(0, $949cefe0e606d775$export$923ea8233b386e99)}?search=${query}`);
        $e58a49189aca5ad3$export$ca000e230c0caa3e.search.results = data.data.recipes.map(function(recipe) {
            return {
                id: recipe.id,
                title: recipe.title,
                publisher: recipe.publisher,
...
const $e58a49189aca5ad3$export$fc57ae4b60b20eca = function(page = $e58a49189aca5ad3$export$ca000e230c0caa3e.search.page) {
    $e58a49189aca5ad3$export$ca000e230c0caa3e.search.page = page;
    const start = (page - 1) * $e58a49189aca5ad3$export$ca000e230c0caa3e.search.resultPerPage;
    const end = page * $e58a49189aca5ad3$export$ca000e230c0caa3e.search.resultPerPage;
    return $e58a49189aca5ad3$export$ca000e230c0caa3e.search.results.slice(start, end);
};
const $e58a49189aca5ad3$export$43630f7a3a617b54 = function(updateserve) {
    $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.ingredients.map(function(ing) {
        return ing.quantity = ing.quantity * updateserve / $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.servings;
    });
    return $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.servings = updateserve;
};
const $e58a49189aca5ad3$var$storeBookmark = function() {
    localStorage.setItem('bookmarkarr', JSON.stringify($e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr));
};
const $e58a49189aca5ad3$export$72009cc673d27d80 = function(recipe) {
    console.log(recipe);
    $e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr.push(recipe);
    if ($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.id === recipe.id) return $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.bookmarked = true;
    $e58a49189aca5ad3$var$storeBookmark();
};
const $e58a49189aca5ad3$export$2db69b245b3902c8 = function(id) {
    const index = $e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr.findIndex(function(bookmark) {
        return bookmark.id === id;
    });
    $e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr.splice(index, 1);
    if ($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.id === id) return $e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.bookmarked = false;
    $e58a49189aca5ad3$var$storeBookmark();
};
const $e58a49189aca5ad3$var$getstoreBookmark = function() {
    const data = JSON.parse(localStorage.getItem('bookmarkarr'));
    console.log(data);
    if (data) $e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr = data;
};
$e58a49189aca5ad3$var$getstoreBookmark();




console.log((0, {}));
class $454ec5fd5c47c855$export$2e2bcd8739ae039 {
    _data;
    render(data) {
    ...
    <div class="error">
        <div>
          <svg>
            <use href="${(0, {})}#icon-alert-triangle"></use>
          </svg>
        </div>
        <p>${errMessage}</p>
      </div>
...
class $4cf72320dbfc2daa$var$RenderRecipeView extends (0, $454ec5fd5c47c855$export$2e2bcd8739ae039) {
        ...
        <figure class="recipe__fig">
         ...
         <div class="recipe__details">
           ...
           <div class="recipe__info">
             ...
             <div class="recipe__info-buttons">
               <button class="btn--tiny btn--increase-servings" data-updateto=${this._data.servings - 1}>
                 <svg>
                   <use href="${0, {}}#icon-minus-circle"></use>
                 </svg>
               </button>
               <button class="btn--tiny btn--increase-servings" data-updateto=${this._data.servings + 1}>
                 <svg>
                   <use href="${0, {}}#icon-plus-circle"></use>
                 </svg>
               </button>
             </div>
           </div>
           ...
           <div class="recipe__user-generated">
             <svg>
               <use href="${0, {}}#icon-user"></use>
             </svg>
           </div>
           <button class="btn--bookmark btn--round">
             <svg class="">
               <use href="${0, {}}#icon-bookmark${this._data.bookmarked === true ? '-fill' : ''}"></use>
             </svg>
           </button>
         </div>
         ...
         <div class="recipe__directions">
           ...
           >
             ...
             <svg class="search__icon">
               <use href="${0, {}}#icon-arrow-right"></use>
             </svg>
           </a>
         </div>
       `;
...
var $4cf72320dbfc2daa$export$2e2bcd8739ae039 = new $4cf72320dbfc2daa$var$RenderRecipeView();


class $2cca69d246c831d3$var$SearchQuery {
...
var $2cca69d246c831d3$export$2e2bcd8739ae039 = new $2cca69d246c831d3$var$SearchQuery();



class $5db606e2611c8217$var$RenderSearchView extends (0, $454ec5fd5c47c855$export$2e2bcd8739ae039) {
...
var $5db606e2611c8217$export$2e2bcd8739ae039 = new $5db606e2611c8217$var$RenderSearchView();




class $37bae978e639feac$var$RenderPaginationView extends (0, $454ec5fd5c47c855$export$2e2bcd8739ae039) {
    ...
    _generateHTML() {
        ...
        if (curPage === 1 && numPage > curPage) return `
        ...
        if (curPage < numPage) return `
            <button class="btn--inline pagination__btn--prev" data-gotopage= ${curPage - 1}>
               <svg class="search__icon">
                 <use href="${0, {}}#icon-arrow-left"></use>
               </svg>
               <span>Page ${curPage - 1}</span>
             </button>
             <button class="btn--inline pagination__btn--next" data-gotopage= ${curPage + 1}>
...
var $37bae978e639feac$export$2e2bcd8739ae039 = new $37bae978e639feac$var$RenderPaginationView();



class $2768b6db7fa50c51$var$RenderBookmarkView extends (0, $454ec5fd5c47c855$export$2e2bcd8739ae039) {
...
var $2768b6db7fa50c51$export$2e2bcd8739ae039 = new $2768b6db7fa50c51$var$RenderBookmarkView();



class $7c1e636ad6e1196e$var$AddRecipeView extends (0, $454ec5fd5c47c855$export$2e2bcd8739ae039) {
...
var $7c1e636ad6e1196e$export$2e2bcd8739ae039 = new $7c1e636ad6e1196e$var$AddRecipeView;


console.log('working fine');
///////////////////////////////////////
const $51e55805949f51d8$var$LoadRecipe = async function() {
    try {
        const id = window.location.hash.slice(1);
        if (!id) return;
        (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).renderSpinner();
        await $e58a49189aca5ad3$export$b96725c7a035d60b(id);
        (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe);
        (0, $5db606e2611c8217$export$2e2bcd8739ae039).update($e58a49189aca5ad3$export$fc57ae4b60b20eca());
        (0, $2768b6db7fa50c51$export$2e2bcd8739ae039).update($e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr);
    } catch (err) {
        (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).renderErr();
    }
};
const $51e55805949f51d8$var$LoadSearchQuery = async function() {
    try {
        const query = (0, $2cca69d246c831d3$export$2e2bcd8739ae039).getQuery();
        console.log(query);
        (0, $5db606e2611c8217$export$2e2bcd8739ae039).renderSpinner();
        await $e58a49189aca5ad3$export$1a43a08845d6b60(query);
        (0, $5db606e2611c8217$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$fc57ae4b60b20eca());
        (0, $37bae978e639feac$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$ca000e230c0caa3e.search);
    } catch (err) {
        (0, $5db606e2611c8217$export$2e2bcd8739ae039).renderErr();
    }
};
const $51e55805949f51d8$var$Pagination = function(gotoPage) {
    console.log(gotoPage);
    (0, $5db606e2611c8217$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$fc57ae4b60b20eca(gotoPage));
    (0, $37bae978e639feac$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$ca000e230c0caa3e.search);
};
const $51e55805949f51d8$var$UpdateServing = function(updateto) {
    $e58a49189aca5ad3$export$43630f7a3a617b54(updateto);
    (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).update($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe);
};
const $51e55805949f51d8$var$controlBookMark = function() {
    if (!$e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.bookmarked) $e58a49189aca5ad3$export$72009cc673d27d80($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe);
    else $e58a49189aca5ad3$export$2db69b245b3902c8($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe.id);
    (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).update($e58a49189aca5ad3$export$ca000e230c0caa3e.recipe);
    (0, $2768b6db7fa50c51$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr);
};
const $51e55805949f51d8$var$controlBookmarked = function() {
    (0, $2768b6db7fa50c51$export$2e2bcd8739ae039).render($e58a49189aca5ad3$export$ca000e230c0caa3e.bookmarkArr);
};
const $51e55805949f51d8$var$init = function() {
    (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).addHanlderLoad($51e55805949f51d8$var$LoadRecipe);
    (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).addHandlerUpdateServing($51e55805949f51d8$var$UpdateServing);
    (0, $2cca69d246c831d3$export$2e2bcd8739ae039).addHandlerQuery($51e55805949f51d8$var$LoadSearchQuery);
    (0, $37bae978e639feac$export$2e2bcd8739ae039).addHandlerPage($51e55805949f51d8$var$Pagination);
    (0, $4cf72320dbfc2daa$export$2e2bcd8739ae039).addHandlerBookmark($51e55805949f51d8$var$controlBookMark);
    (0, $2768b6db7fa50c51$export$2e2bcd8739ae039).addHandlerBookmarked($51e55805949f51d8$var$controlBookmarked);
};
$51e55805949f51d8$var$init();


//# sourceMappingURL=starter.c4c863c4.js.map
