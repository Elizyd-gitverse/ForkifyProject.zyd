...
var _renderRecipeViewJs = require("./Views/RenderRecipeView.js");
var _renderRecipeViewJsDefault = parcelHelpers.interopDefault(_renderRecipeViewJs);
var _searchQueryJs = require("./Views/SearchQuery.js");
var _searchQueryJsDefault = parcelHelpers.interopDefault(_searchQueryJs);
var _renderSearchViewJs = require("./Views/renderSearchView.js");
var _renderSearchViewJsDefault = parcelHelpers.interopDefault(_renderSearchViewJs);
var _renderPaginationViewJs = require("./Views/RenderPaginationView.js");
var _renderPaginationViewJsDefault = parcelHelpers.interopDefault(_renderPaginationViewJs);
var _renderBookmarkViewJs = require("./Views/RenderBookmarkView.js");
...
const LoadRecipe = async function() {
    try {
        ...
        if (!id) return;
        (0, _renderRecipeViewJsDefault.default).renderSpinner();
        await _modalJs.loadRecipe(id);
        (0, _renderRecipeViewJsDefault.default).render(_modalJs.state.recipe);
        (0, _renderSearchViewJsDefault.default).update(_modalJs.searchPerPage());
        (0, _renderBookmarkViewJsDefault.default).update(_modalJs.state.bookmarkArr);
    } catch (err) {
        (0, _renderRecipeViewJsDefault.default).renderErr();
    }
};
const LoadSearchQuery = async function() {
    try {
        const query = (0, _searchQueryJsDefault.default).getQuery();
        console.log(query);
        (0, _renderSearchViewJsDefault.default).renderSpinner();
        await _modalJs.loadSearch(query);
        (0, _renderSearchViewJsDefault.default).render(_modalJs.searchPerPage());
        (0, _renderPaginationViewJsDefault.default).render(_modalJs.state.search);
    } catch (err) {
        (0, _renderSearchViewJsDefault.default).renderErr();
    }
};
const Pagination = function(gotoPage) {
    console.log(gotoPage);
    (0, _renderSearchViewJsDefault.default).render(_modalJs.searchPerPage(gotoPage));
    (0, _renderPaginationViewJsDefault.default).render(_modalJs.state.search);
};
const UpdateServing = function(updateto) {
    _modalJs.updateServing(updateto);
    (0, _renderRecipeViewJsDefault.default).update(_modalJs.state.recipe);
};
const controlBookMark = function() {
    if (!_modalJs.state.recipe.bookmarked) _modalJs.addBookmark(_modalJs.state.recipe);
    else _modalJs.removeBookmark(_modalJs.state.recipe.id);
    (0, _renderRecipeViewJsDefault.default).update(_modalJs.state.recipe);
    (0, _renderBookmarkViewJsDefault.default).render(_modalJs.state.bookmarkArr);
};
const controlBookmarked = function() {
    (0, _renderBookmarkViewJsDefault.default).render(_modalJs.state.bookmarkArr);
};
const init = function() {
    (0, _renderRecipeViewJsDefault.default).addHanlderLoad(LoadRecipe);
    (0, _renderRecipeViewJsDefault.default).addHandlerUpdateServing(UpdateServing);
    (0, _searchQueryJsDefault.default).addHandlerQuery(LoadSearchQuery);
    (0, _renderPaginationViewJsDefault.default).addHandlerPage(Pagination);
    (0, _renderRecipeViewJsDefault.default).addHandlerBookmark(controlBookMark);
    (0, _renderBookmarkViewJsDefault.default).addHandlerBookmarked(controlBookmarked);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./modal.js":"jJ31c","./Views/RenderRecipeView.js":"5jo8h","./Views/SearchQuery.js":"Wfkm1","./Views/renderSearchView.js":"b4daN","./Views/RenderPaginationView.js":"dHQc3","./Views/RenderBookmarkView.js":"6Slfc","./Views/addRecipeview.js":"h25Pr","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
var _helperFunctionJs = require("./helperFunction.js");
...
const loadRecipe = async function(id) {
    try {
        const data = await (0, _helperFunctionJs.getJson)(`${(0, _configJs.API_URL)}${id}`);
        ...
        if (state.bookmarkArr.some(function(bookmark) {
...
const loadSearch = async function(query) {
    try {
        const data = await (0, _helperFunctionJs.getJson)(`${(0, _configJs.API_URL)}?search=${query}`);
...
const updateServing = function(updateserve) {
...
},{"./helperFunction.js":"lh176","./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lh176":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5jo8h":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./ParentView":"ffCDk","fracty":"gsPKI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"ffCDk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"regenerator-runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"d6UCS":[function() {},{}],"gsPKI":[function(require,module,exports,__globalThis) {
...
},{}],"d6UCS":[function() {},{}],"Wfkm1":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchQuery {
...
exports.default = new SearchQuery();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"b4daN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parentView = require("./ParentView");
var _parentViewDefault = parcelHelpers.interopDefault(_parentView);
class RenderSearchView extends (0, _parentViewDefault.default) {
...
exports.default = new RenderSearchView();

},{"./ParentView":"ffCDk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dHQc3":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parentView = require("./ParentView");
var _parentViewDefault = parcelHelpers.interopDefault(_parentView);
...
},{"./ParentView":"ffCDk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../../img/icons.svg":"d6UCS"}],"d6UCS":[function() {},{}],"6Slfc":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parentView = require("./ParentView");
var _parentViewDefault = parcelHelpers.interopDefault(_parentView);
class RenderBookmarkView extends (0, _parentViewDefault.default) {
...
exports.default = new RenderBookmarkView();

},{"./ParentView":"ffCDk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"h25Pr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _parentView = require("./ParentView");
var _parentViewDefault = parcelHelpers.interopDefault(_parentView);
...
},{"./ParentView":"ffCDk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire3a11", {})
